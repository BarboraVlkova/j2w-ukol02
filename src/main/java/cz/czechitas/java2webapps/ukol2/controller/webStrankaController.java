...
//    }
    ...
    public ModelAndView zmenaVzhleduStranky() {
        ...
        List<String> citaty = Arrays.asList("„Všichni vědí naprosto přesně, jak mají žít druzí. Zato nikdy nevědí, jak mají žít oni sami.“ —  Paulo Coelho", "„Uprostřed problémů leží příležitost.“ —  Albert Einstein", "„Nechtěj být člověkem, který je úspěšný, ale člověkem, který za něco stojí.“ —  Albert Einstein", "„Ono je lepší mluvit s chytrým člověkem o něčem hloupém než s hlupákem o něčem chytrém.“ —  Jan Werich", "„Bylo by to k smíchu, kdyby to nebylo k pláči.“ —  Jan Werich", "„Vodu neoceníme, dokud nám nevyschne studna a to platí o všem v životě.“ —  Benjamin Franklin", "„Život bez zkoušek nestojí za žití.“ —  Sókratés", "„Odmítáme ty co nás milují, a milujeme ty co nás odmítají.“ —  Seneca");
        int seznamScitaty = nahodneCislo.nextInt(citaty.size());
        result.addObject("citaty", citaty.get(seznamScitaty));

        List<String> obrazky = Arrays.asList("https://source.unsplash.com/DGFwQWKf-5o/1600x900","https://source.unsplash.com/5iW15BLz_2M/1600x900","https://source.unsplash.com/dx_6rdMmuzM/1600x900", "https://source.unsplash.com/DGFwQWKf-5o/1600x900", "https://source.unsplash.com/fkfKa0E1muw/1600x900", "https://source.unsplash.com/SPvJPDXEmqA/1600x900", "https://source.unsplash.com/Q_JjO7uaTh4/1600x900", "https://source.unsplash.com/vBos7bw98bY/1600x900");
        int seznamSobrazky = nahodneCislo.nextInt(obrazky.size());
        result.addObject("obrazky", obrazky.get(seznamSobrazky));
        return result;
    }
